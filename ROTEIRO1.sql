...
CREATE TABLE AUTOMOVEL(
NUMERO_CHASSI CHAR(17) NOTNULL, -- ADICIONEI ISSO PORQUE NO MUNDO REAL EH UTILIZADO COMO MEIO DE IDENTIFICAO, MAS CONTINUEI USANDO A PLACA 
MODELO VARCHAR(30),
MARCA VARCHAR(30),
PLACA CHAR(7) NOTNULL,
COR VARCHAR(20),
ANO_FABRICACAO DATE NOTNULL, -- ADICIONEI ISSO PARA QUE ESSA TABELA TENHA INFORMACOES FARTAS SOBRE O OBJETO REAL RELACIONADO. 
RENAVAM INTEGER NOTNULL,
PRIMARY KEY(PLACA)
);
...
PLACA_AUTOMOVEL CHAR(7) NOTNULL,
COBERTURA TEXT,
PRIMARY KEY(APOLICE_SEGURO),
CONSTRAINT seguro_cpf_segurado_fkey FOREIGN KEY (CPF_SEGURADO) REFERENCES SEGURADO (CPF),
CONSTRAINT seguro_placa_automovel_fkey FOREIGN KEY (PLACA_AUTOMOVEL) REFERENCES AUTOMOVEL (PLACA)
...
DATA_OCORRIDO TIMESTAMP NOTNULL,
APOLICE_SEGURO VARCHAR(30) NOTNULL,
LOCALIZACAO VARCHAR(50) NOTNULL,
